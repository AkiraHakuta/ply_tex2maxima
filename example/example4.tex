% example4.tex   Author: Akira Hakuta, Date: 2017/05/27
% pdflatex.exe -synctex=1 -interaction=nonstopmode example4.tex
% pythontex.exe example4.tex
% pdflatex.exe -synctex=1 -interaction=nonstopmode example4.tex 
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textgt{{\Large~数学\,I\,演習}~~{\Large ~第１章~数と式~~~~}{\bf\large No.~4}
